...
function ContactUs() {
    ...
    return (
        <Layout1>
            <Box>
                <center>
                    <Box sx={{ background: '#27460B', padding: '10px 0 10px 0' }}>
                        <Typography sx={{ fontSize: '28px', fontFamily: 'Platypi, serif', fontWeight: 'bold', color: 'white' }}>Contact Us</Typography>
                    </Box>
                    <br />
                        ...
                        <Grid container spacing={2}>
                            <Grid item md={6} xs={12} sx={{ paddingLeft: '10px' }}>
                                <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                                    <Typography sx={{ fontSize: '28px', fontFamily: 'Platypi, serif', fontWeight: 'bold' }}>Get In Touch</Typography>
                                </Box>
