                        ...
                        <Table>
                            ...
                            <TableBody>
                                {(rowsPerPage > 0
                                    ...
                                    if (searchUser === "") {
                                        return element;
                                    } else if ((element.name.toLowerCase()).includes(searchUser.toLowerCase())) {
                                        return element;
                                    } else if ((element.email.toLowerCase()).includes(searchUser.toLowerCase())) {
                                        return element;
                                    } else if ((element.address.toLowerCase()).includes(searchUser.toLowerCase())) {
                                        return element;
                                    }
                                }).map((row, i) => (
