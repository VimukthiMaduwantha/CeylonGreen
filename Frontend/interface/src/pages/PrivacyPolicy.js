...
function PrivacyPolicy() {
    ...
    return (
        <>
            <Layout1>
                <Box>
                    <Box sx={{ background: '#27460B', padding: '10px 0 10px 0', display: 'flex', justifyContent: 'center' }}>
                        <Typography sx={{ fontSize: '28px', fontFamily: 'Platypi, serif', fontWeight: 'bold', color: 'white' }}>Privacy Policy</Typography>
                    </Box>
                    <br />
